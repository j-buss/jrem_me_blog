...
**Theorem 6.8 [Normal Approx to Binomial Distribution]** If \(X\) is a random variable having a binomial distribution with the parmeters \(n\) and \(\theta\), then the moment generating function of 

\[
Z = \frac{X-n \theta}{\sqrt{n \theta (1-\theta)}}
\]

approaches that of the standard normla distribution when \(n\rightarrow \infty\)
